            ...
            <div class="layout-config-content">
                <div class="layout-config-section options">
                    ...
                    <div class="p-formgroup-inline menu-type p-grid p-nogutter">
                        <div class="p-field-radiobutton p-md-6">
                            <p-radioButton inputId="static" name="layoutMode" value="static"
                                           [(ngModel)]="app.layoutMode"></p-radioButton>
                            <label for="static">Static</label>
                        </div>
                        <div class="p-field-radiobutton p-md-6">
                            <p-radioButton inputId="overlay" name="layoutMode" value="overlay"
                                           [(ngModel)]="app.layoutMode"></p-radioButton>
                            <label for="overlay">Overlay</label>
                        </div>
                        <div class="p-field-radiobutton p-md-6">
                            <p-radioButton inputId="horizontal" name="layoutMode" value="horizontal"
                                           [(ngModel)]="app.layoutMode"
                                           (onClick)="app.inlineUser = false"></p-radioButton>
                            <label for="horizontal">Horizontal</label>
                        </div>
                        <div class="p-field-radiobutton p-md-6">
                            <p-radioButton inputId="slim" name="layoutMode" value="slim"
                                           [(ngModel)]="app.layoutMode"></p-radioButton>
                ...
                <div class="layout-config-section options">
                    ...
                    <div class="p-formgroup-inline p-grid p-nogutter">
                        <div class="p-field-radiobutton p-md-6">
                            <p-radioButton inputId="dark" name="menuColor" [value]="false"
                                           [(ngModel)]="app.lightMenu"></p-radioButton>
                            <label for="dark">Dark</label>
                        </div>
                        <div class="p-field-radiobutton p-md-6">
                            <p-radioButton inputId="light" name="menuColor" [value]="true"
                                           [(ngModel)]="app.lightMenu"></p-radioButton>
                ...
                <div class="layout-config-section options">
                    ...
                    <div class="p-formgroup-inline p-grid p-nogutter">
                        <div class="p-field-radiobutton p-md-6">
                            <p-radioButton inputId="inline" name="profileMode" [value]="true"
                                           [(ngModel)]="app.inlineUser"
                                           [disabled]="appMain.isHorizontal()"></p-radioButton>
                            <label for="inline">Inline</label>
                        </div>
                        <div class="p-field-radiobutton p-md-6">
                            <p-radioButton inputId="top" name="profileMode" [value]="false"
                                           [(ngModel)]="app.inlineUser"></p-radioButton>
                ...
                <div class="layout-config-section options">
                    ...
                    <div class="p-formgroup-inline p-grid p-nogutter">
                        <div class="p-field-radiobutton p-md-6">
                            <p-radioButton inputId="ltr" name="isRTL" [value]="false"
                                           [(ngModel)]="app.isRTL"></p-radioButton>
                            <label for="ltr">LTR</label>
                        </div>
                        <div class="p-field-radiobutton p-md-6">
                            <p-radioButton inputId="rtl" name="isRTL" [value]="true"
                                           [(ngModel)]="app.isRTL"></p-radioButton>
                ...
                <div class="layout-config-section colors">
                    ...
                    <div class="layout-themes topbar-colors">
                        <div *ngFor="let topbarColor of topbarColors">
                            <a style="cursor: pointer" class="layout-config-option-color"
                ...
                <div class="layout-config-section colors">
                    ...
                    <div class="layout-themes">
                        <div *ngFor="let t of themes">
                            <a style="cursor: pointer" (click)="changeTheme(t.label)"
